...
setInterval(()=>{
    let temp = ""
    if(adc.read(JOYX_PIN)>700)temp += "D"
    if(adc.read(JOYX_PIN)<300)temp += "A"
    if(adc.read(JOYY_PIN)>700)temp += "S"
    if(adc.read(JOYY_PIN)<300)temp += "W"
    if(adc.read(JOY2X_PIN)>700)temp += "<"
    if(adc.read(JOY2X_PIN)<300)temp += ">"
    if(adc.read(JOY2Y_PIN)>700)temp += "i"
    if(adc.read(JOY2Y_PIN)<300)temp += "j"
